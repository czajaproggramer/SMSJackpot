...
public class Postman
{
    ...
    public void SendInitialMessageToAllUncontactedLeads(IDeliveryMethod delivery)
    {
        ...
        {
            delivery.SendMessage(lead, Camp.Template);
    ...
    public void SendBaseFollowup(IDeliveryMethod delivery)
    {
        ...
        {
            delivery.SendMessage(lead, "Dzien dobry, przypominam sie");
        }
